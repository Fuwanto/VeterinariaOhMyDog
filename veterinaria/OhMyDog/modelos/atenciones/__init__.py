...
def crear_atencion_clinica(perro, fecha, observacion):
    ...
    atencion = Atencion(
        ...
        url_mostrar_datos="datos_atencion_clinica",
    )
    atencion.save()
...
def crear_consulta(perro, fecha, observacion):
    ...
    atencion = Atencion(
        ...
        observacion=observacion,
        tipo_atencion=tipo_atencion,
        url_mostrar_datos="datos_consulta",
    )
    atencion.save()
...
def crear_desparasitacion(perro, fecha, diagnostico, farmaco, fabricante, num_serie, num_lote, dosis, observacion):
    ...
    atencion = Atencion(
        ...
        observacion=observacion,
        tipo_atencion=tipo_atencion,
        url_mostrar_datos="datos_desparasitacion",
    )
    atencion.save()
...
def crear_castracion(perro, fecha, observacion):
    ...
    atencion = Atencion(
        ...
        observacion=observacion,
        tipo_atencion=tipo_atencion,
        url_mostrar_datos="datos_castracion",
    )
    atencion.save()
...
def crear_vacunacion(perro, fecha, vacuna, fabricante, num_serie, num_lote, dosis, observaciones):
    ...
    atencion = Atencion(
        ...
        tipo_atencion=tipo_atencion,
        url_mostrar_datos="datos_vacunacion",
    )
    atencion.save()
...
def buscar_desparasitacion_por_atencion_id(atencion_id):
    try:
        atencion = Atencion.objects.get(id=atencion_id)
