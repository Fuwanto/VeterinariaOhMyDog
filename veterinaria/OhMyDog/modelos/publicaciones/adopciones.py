...
class Adopcion(models.Model):
    ...
    tamanio_perro = models.ForeignKey(TamanioPerro, null=False, on_delete=models.CASCADE)
    etapa_vida_perro = models.ForeignKey(EtapaVidaPerro, null=False, on_delete=models.CASCADE)
